...
export async function createTestData(graph: Vertex): Promise<void> {
    ...
    await graph.runAsSystem(
        ...
        CreatePerson({slugId: "the-rock", name: "Dwayne Johnson", dateOfBirth: VD`1972-05-02`}),
        ...
        CreatePerson({slugId: "chris-pratt", name: "Chris Pratt", dateOfBirth: VD`1979-06-21`}),
        ...
        CreatePerson({slugId: "kate-mckinnon", name: "Kate McKinnon", dateOfBirth: VD`1984-01-06`}),
        ...
        CreatePerson({slugId: "scarlett-johansson", name: "Scarlett Johansson", dateOfBirth: VD`1984-11-22`}),
        ...
        CreatePerson({slugId: "ilana-glazer", name: "Ilana Glazer", dateOfBirth: VD`1987-04-12`}),
        ActedIn({personId: "ilana-glazer", movieId: "rough-night", role: "Frankie"}),

        CreatePerson({slugId: "karen-gillan", name: "Karen Gillan", dateOfBirth: VD`1987-11-28`}),
